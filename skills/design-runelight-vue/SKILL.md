...
description: Create and iterate product GUI design drafts for Vue Runelight projects using Studio design frames in project.entryRoot/design/*.g.vue. Use when the user asks for design exploration, UI drafts, visual prototypes, making a product surface look good, or adjusting an existing Runelight design board in a Vue project.
---
