...
describe("examples Vite host", () => {
  it("checks and captures every renderable GTSX example", async () => {
    ...
    expect(check.stdout).toContain("GTSX pure entry: src/frames/language/PrimitiveProps.g.tsx")
    expect(check.stdout).toContain("GTSX pure entry: src/frames/ui/NotificationCenter.g.tsx")
    expect(check.stdout).toContain("GTSX scope entry: src/frames/stateful/UserCard.g.tsx")
    expect(check.stdout).toContain("GTSX pure entry: src/frames/stateful/DashboardShell.g.tsx")
    expect(check.stdout).toContain("GTSX scope entry: src/frames/stateful/NotificationBell.g.tsx")
