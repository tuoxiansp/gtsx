...
import { extractVueFrames, isRunelightVueComponentFile } from "./contract-analyzer.js"

export const RUNELIGHT_VUE_PREVIEW_QUERY = "runelight-preview"
...
export function transformRunelightVuePreviewSfc(
  ...
  const previewRuntimeImport = options.previewRuntimeImport ?? "@runelight/vue/preview"
