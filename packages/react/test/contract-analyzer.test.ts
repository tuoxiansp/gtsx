...
import { analyzeRunelightReactEntry as analyzeEntry } from "../src/contract.js"

const fixtureRoot = join(import.meta.dirname, "../../core/test/fixtures/check-project")
const framesBeforeExportRoot = join(import.meta.dirname, "../../core/test/fixtures/frames-before-export")
const jsxControlFlowRoot = join(import.meta.dirname, "../../core/test/fixtures/jsx-control-flow")
const providerUseUpdateRoot = join(import.meta.dirname, "fixtures/provider-use-update")
...
describe("Runelight analyzer", () => {
  ...
  it("reports contract diagnostics for malformed entries", () => {
    ...
    const providerUseUpdate = analyzeEntry({ cwd: providerUseUpdateRoot, entry: "src/ProviderUseUpdate.g.tsx" })
