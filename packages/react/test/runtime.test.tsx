...
import { GPreviewProvider, createGBoundaryCollector } from "../src/runtime.js"
...
describe("Runelight runtime", () => {
  ...
  it("delegates a Runelight scope hook to the real hook by default", () => {
  ...
  it("records Runelight boundary parent-child relationships through runtime context", () => {
    ...
    expect(parentId).toMatch(/^runelight-boundary:/)
    expect(childId).toMatch(/^runelight-boundary:/)
  ...
  it("records serialized props, scope, and provider values for each boundary instance without executing functions", () => {
    ...
    expect(boundaryId).toMatch(/^runelight-boundary:/)
