...
export function transformRunelightComponentBoundaries(input: RunelightReactTransformInput): string {
  ...
  if (hasComponentBoundaries) {
    ...
    insertions.push({
      ...
      text: `${importInsertionIndex === 0 ? "" : "\n"}import { defineGComponent as __runelightDefineGComponent } from "@runelight/core"\n`,
    })
  }
...
export function transpileRunelightReactModuleCode(input: { code: string; filePath: string }): string {
