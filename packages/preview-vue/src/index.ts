...
export const RunelightVuePreviewDocumentBackground = defineComponent({
...
export const RunelightVuePreviewMessage = defineComponent({
...
function ensureRunelightVuePreviewRenderTargetMailbox(): RunelightVuePreviewRenderTargetMailbox | null {
  ...
  let currentTarget = window.__runelightPreviewPendingRenderTarget
    ? previewRouteParamsFromRenderTarget(window.__runelightPreviewPendingRenderTarget, 0)
    : null
  ...
  if (window.__runelightPreviewPrehydrationMailboxInstalled) {
    window.addEventListener("runelight:preview-render-target", (event) => {
...
export function readRunelightVuePreviewFrameOverrides(params: URLSearchParams): Map<string, string> {
